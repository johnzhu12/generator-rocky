...
if [ $PLATFORM = "darwin" ]; then
    ditto -rsrcFork ./dist/Electronic\ Rocky-darwin-x64/Electronic\ Rocky.app /Applications/Electronic\ Rocky.app
    echo "$(tput setaf 3)App copied to /Applications. You can open Electronic Rocky there or from Spotlight.$(tput sgr0)"
fi
